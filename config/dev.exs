...
config :multi_db_demo, MultiDbDemoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "jUn91+kynGeQAodlqgPW8oddpLUGsltmXpVtUVTMhfwGBaX9vHF+Nsfg/WDcBZXt",
  watchers: [
...
config :multi_db_demo, MultiDbDemoWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/multi_db_demo_web/(live|views)/.*(ex)$",
      ~r"lib/multi_db_demo_web/templates/.*(eex)$"
    ]
  ]
